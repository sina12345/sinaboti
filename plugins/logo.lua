...
local function run(msg, matches)
    local receiver = get_receiver(msg)
		--[[plugin by mohammadnbg Please Don't Remove this ]]
...
return {
  ...
  run = run 
				--[[plugin by moammadnbg to softtg Please Don't Remove this ]]
}
end

		--[[plugin by mohammadnbg to softtg Please Don't Remove this ]]